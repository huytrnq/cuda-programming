...
int main(int argc, char **argv) {
    ...
    // Set kernel to use 2D grid and 2D blocks with 32x32 threads
    // For this setup, the total number of threads is equal to the total number of elements in the matrix
    // Therefore, each thread will compute only one element of the result matrix
    dim3 block(32);
